...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Predict FIFA match winners, earn points, and climb the global leaderboard." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "FIFA Winner Predictor" },
      { name: "twitter:description", content: "Predict FIFA match winners, earn points, and climb the global leaderboard." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ebf463ae-f761-4a81-a73a-67634503bfa4/id-preview-b26d30ba--9d2bc883-cdbb-4027-8ac7-eccaf0ec5606.lovable.app-1781939719287.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ebf463ae-f761-4a81-a73a-67634503bfa4/id-preview-b26d30ba--9d2bc883-cdbb-4027-8ac7-eccaf0ec5606.lovable.app-1781939719287.png" },
    ],
    links: [
